...
def main():
    ...
    parse_site_details_and_send(site_catalog_file, smi_filenames, smi_ids)
...
'''
def parse_site_details_and_send(site_catalog_file, smi_filenames, smi_ids):
    catalog_dict = {}
    ...
    for site in site_data.iter('site'):
        ...
        if site_code in smi_ids:
            ...
            info = '\nSending '+site_localpath+' to '+site_URI+':'+site_remotepath
            print info
            ...
            print info
            gsmlogger.logger.info(info)
            sftp_instance.send_file_to_uri(site_URI, site_uname, site_password,
